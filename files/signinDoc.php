...
if(isset($_POST['submit']))
{
	...
	if(!empty($login_uname) || !empty($login_pass))
	{
		...
		// {
			$login="select * from doctors WHERE UNAME='".$login_uname."' and PASSWORD='".$login_pass."'";
...
<form method="post" action="signinDoc.php" class="font4" enctype="multipart/form-data">
<div>
