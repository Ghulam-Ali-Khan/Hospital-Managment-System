...
if(isset($_POST['submit']))
{
	...
	if(!empty($login_uname) || !empty($login_pass))
	{
		...
		// {
			$login="select * from signupdata WHERE UNAME='".$login_uname."' and PASSWORD='".$login_pass."'";
...
<form method="post" action="signin.php" class="font4" enctype="multipart/form-data">
<div>
...
<div style="width:100%;">
<button type="submit" name="submit" style="width:95px;text-align:center;margin-left:35%">Login</button>
<a href="signup.php" style="margin-left:25%">Creat new account</a>
</div>
</form>
